...
if (isset($POST["submit"])) {
    ...
    $row_jabatan_pilih = mysqli_fetch_assoc($result_jabatan_ambil);
	...
	$query = " UPDATE penggajian SET karyawan_id = '$kayawan_id', tahun = '$tahun', bulan = '$bulan', gapok = '$gapok', tunjangan = '$tunjangan', uang_makan = '$uang_makan' WHERE id = $id ";
	...
	if ($edit) {
		...
		document.location.herf = 'gaji-edit.php?id=$id';
		</script>";
	}
}
...
<head>
    ...
    <title>Edit Data Gaji | PRAKTIKUM FTI UNISKA 2023 </title>
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item"><a href="gaji.php"></a>Gaji</li>
                    	 ...
                    	 <div class="col-md-12">
                            <div class="card card-primary">
                                ...
                                <div class="card-body">
                                	...
                                	<input type="text" class="form-control" id="tahun" name="tahun" value="<?php echo $row_jabatan_ambil["tahun"]; ?> " placeholder="Tahun" required>	
                                	</div>
                                	<div class="form-group">
                                    ...
                                    while ($row_karyawan = mysqli_fetch_assoc($result_karyawan)){
                                        ...
                                        <option value="<?php echo $row_karyawan["id"]; ?>"><?php if (! (strcmp($row_karyawan["id"], htmlentities($row_jabatan_ambil['karyawan_id'], ENT_COMPAT,'utf-8')))){ 
                                            echo "selected"; } ?>> <?php echo $row_karyawan['nama_lengkap'] ?></option>
                                    <?php } ?>
                                </select>
