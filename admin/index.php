...
<head>
    ...
    <title>Home Admin | SKRIPSI FTI UNISKA 2022</title>
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <div class="container-fuild">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1>Sistem Informasi Laporan Data Penilaian Kinerja Guru</h1>
                        </div>
                        <div class="col-sm-6">
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title">DataTable with default featurs</h3>
                                </div>
                                <!-- /.card-header -->
                                <div class="card-body">
