                                        ...
                                        <tbody>
                                            ...
                                            while ($row = mysqli_fetch_assoc($result)) { ?>
                                                <tr>
                                                    <td><?php echo $no; ?></td>
                                                    <td>
                                                        <a href="riwayat-gaji-bulan.php?tahun=<?php echo $row["tahun"]; ?>&id=<?php echo $id ?>&bulan=<?= $row["bulan"] ?>" class="btn btn-success btn-xs mr-1"><i class="fa fa-eye"></i> Per Bulan</a>
                                                    </td>
