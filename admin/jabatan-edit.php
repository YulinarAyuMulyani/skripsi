...
<head>
    ...
    <title>Tambah Data Jabatan | PRAKTIKUM FTI UNISKA 2022</title>
                                ...
                                <form action="" method="post">
                                    <div class="card-body">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="nama_jabatan" name="nama_jabatan" value="<?php echo $row_jabatan["nama_jabatan"]; ?>" placeholder="Nama Jabatan" required>
                                        </div>
                                        <div class="form-group">
                                            <label for="gapok_jabatan">Gapok Jabatan</label>
                                            <input type="text" class="form-control" id="gapok_jabatan" name="gapok_jabatan" value="<?php echo $row_jabatan["gapok_jabatan"]; ?>" placeholder="Gaji Pokok Jabatan" required>
                                        </div>
                                        <div class="form-group">
                                            <label for="tunjangan_jabatan">Tunjangan Jabatan</label>
                                            <input type="text" class="form-control" id="tunjangan_jabatan" name="tunjangan_jabatan" value="<?php echo $row_jabatan["tunjangan_jabatan"]; ?>" placeholder="Tunjangan Jabatan" required>
                                        </div>
                                        <div class="form-group">
                                            <label for="uang_makan_perhari">Uang Makan Perhari</label>
                                            <input type="text" class="form-control" id="uang_makan_perhari" name="uang_makan_perhari" value="<?php echo $row_jabatan["uang_makan_perhari"]; ?>" placeholder="Uang Makan Perhari" required>
                                        </div>
                                    </div>
