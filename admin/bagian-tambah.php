                                ...
                                <form action="" method="post">
                                    <div class="card-body">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="nama_bagian" name="nama_bagian" placeholder="Nama Bagian" required>
                                        </div>
                                        <div class="form-group">
                                            <label for="karyawan_id">Karyawan ID</label>
                                            <input type="text" class="form-control" id="karyawan_id" name="karyawan_id" placeholder="Karyawan ID" required>
                                        </div>
                                        <div class="form-group">
                                            <label for="lokasi_id">Lokasi ID</label>
                                            <input type="text" class="form-control" id="lokasi_id" name="lokasi_id" placeholder="Lokasi ID" required>
                                        </div>
                                    </div>
